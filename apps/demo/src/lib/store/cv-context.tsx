...
import type { CVMetadata, RawCinodeData } from '@/lib/file-formats/types';
import { CURRENT_SCHEMA_VERSION } from '@/lib/file-formats/cv-file.schema';
...
import type { CVStorageAdapter } from '@/lib/storage/cv-storage';
