...
import { searchOntology, type OntologySuggestion } from '@/lib/ontology';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { AddSkillForm as CreateSkillSubForm } from '@/app/cv/skill-editor';
import type { GraphContext } from '@/app/cv/SkillGraphModal';

const SkillGraphModal = lazy(() =>
  import('@/app/cv/SkillGraphModal').then((m) => ({ default: m.SkillGraphModal })),
);
