...
import { CoverPage } from '@/app/cv/cover-page';
import { getBodySectionTitle } from '@/lib/get-body-section-title';
...
export function PaginatedPrintLayout({
  cv,
  locale,
  themeId = brandConfig.defaultPrintThemeId,
  themeClassName,
  spec = null,
  ...
  const pageConfig = useMemo(
    () => getPageConfigForTheme(themeId, PAGE_CONFIG),
    [themeId],
  );
