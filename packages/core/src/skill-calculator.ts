...
/**
 * @deprecated Use competence-service (recalculateYears, calculatedYears) instead.
 * This module is no longer wired into the store; cv.skills[].calculatedYears
 * is set by src/lib/competence/competence-service.ts.
 *
