 ...
 */
export function blockStartsNewPage(brandConfig: BrandConfig, themeId: string | undefined, blockType: BlockType): boolean {
 ...
 */
export function showHeaderOnCover(brandConfig: BrandConfig, themeId: string | undefined): boolean {
 ...
 * Defaults to true when the theme has no explicit config.
 */
export function showFooterOnCover(brandConfig: BrandConfig, themeId: string | undefined): boolean {
  if (!themeId) return true;
