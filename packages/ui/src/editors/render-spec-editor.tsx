...
import type { Locale, RenderSpec } from '@cvsystem/core';
import { getBilingualText } from '@cvsystem/core';
import { useRenderSpecs } from '../store/cv-store';
import { useRoles, useHobbyProjects, useTrainings, useEducations, useCommitments } from '../store/cv-store';
