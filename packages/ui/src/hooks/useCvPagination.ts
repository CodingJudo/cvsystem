...
import { buildSectionsFromCv } from '@cvsystem/core';
import { attachHeaderFooterToSections } from '../lib/print-theme-config';
import { paginateCv, logPaginationDebug } from '@cvsystem/core';
import { applyRenderSpec } from '@cvsystem/core';
import type { DomainCV, RenderSpec } from '@cvsystem/core';
import type {
  SectionSpec,
  PageConfig,
  HeaderFooterDef,
...
export function useCvPagination(
  ...
  }, [cv, themeId, paginationConfig?.granularity, locale, spec, brandConfig]);
